...
def parse():
    ...
    p.add_argument('--seed', type=int, default=4202, help='seed for randomness')
    ...
    p.add_argument('--lambda_h', type=float, default=0.1, help="Homophily weight parameter")
    p.add_argument('--k', type=int, default=10, help="Ratio of injected hyperedges")
    p.add_argument('--ir', type=float, default=0.05, help="Ratio of injected nodes")
    return p.parse_args()
